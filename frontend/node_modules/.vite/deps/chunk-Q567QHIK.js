...
var undoCommand = (state, dispatch) => {
  var _a, _b;
  return dispatch == null ? (_b = (_a = yUndoPluginKey.getState(state)) == null ? void 0 : _a.undoManager) == null ? void 0 : _b.canUndo() : undo(state);
};
var redoCommand = (state, dispatch) => {
  var _a, _b;
  return dispatch == null ? (_b = (_a = yUndoPluginKey.getState(state)) == null ? void 0 : _a.undoManager) == null ? void 0 : _b.canRedo() : redo(state);
};
...
//# sourceMappingURL=chunk-Q567QHIK.js.map
